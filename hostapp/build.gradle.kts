...
//                because("Plotline SDK  Maven artifact dowload from jitpack")
//            }
//        }
//    }
//}
//
//subprojects {
//    // Target the Plotline RN module only (both by Gradle path and by location under node_modules)
//    val isPlotlineModule =
//        (path == ":plotline-engage") ||
//                projectDir.path.contains("node_modules/plotline-engage/android")
//
//    if (isPlotlineModule) {
